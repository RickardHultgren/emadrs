...
Vid Hagors v{\aa}rdcentral {\"a}r personalens attityd positiv till digitala formul{\"a}r p{\aa} patientens smartphone. De tycker att screening och uppf{\"o}ljning via s{\aa}dana vertktyg antagligen skulle vara f{\"o}rdelaktigt f{\"o}r arbetet v{\aa}rdcentralen. Resultaten visar att det b{\"o}r finnas m{\"o}jlighet f{\"o}r v{\aa}rdpersonal att styra vilka formul{\"a}r patienten skickar till sjukv{\aa}rden. Vad g{\"a}ller digital form av \textsc{madrs-s} b{\"o}r formul{\"a}ret i f{\"o}rsta hand anv{\"a}ndas vid uppf{\"o}ljning. De personalkategorier vars arbete skulle p{\aa}verkas mest av digitala formul{\"a}r {\"a}r sjuksk{\"o}terskor, administrat{\"o}rer och samltalsterapeuter. 
