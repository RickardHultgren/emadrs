...
H{\"a}lso- och sjukv{\aa}rden {\"a}r ofta inriktad p{\aa} att hj{\"a}lpa patienterna att sj{\"a}lv hantera ett h{\"a}lsoproblem eller hj{\"a}lpa sjukv{\aa}rdspersonal i sitt arbete. Mindre anstr{\"a}ngning l{\"a}ggs p{\aa} kommunikationen och dynamiken mellan v{\aa}rden och patienten. Resultaten fr{\aa}n en interaktion mellan patient och v{\aa}rd beror mycket p{\aa} den professionalla bakgrunden hos v{\aa}rdgivarens representant\cite{dynamics1, dynamics2}. Fr{\aa}geformul{\"a}r kan potentiellt vara ett objektivt verktyg f{\"o}r att s{\"a}kerst{\"a}lla att patienternas behov alltid {\"a}r likv{\"a}rdigt uppfyllda. Den stora utmaningen med fr{\aa}geformul{\"a}r {\"a}r att {\"a}ven om kommunikationen alltid kan vara objektiv och likv{\"a}rdigt, beh{\"o}ver den inte n{\"o}dv{\"a}ndigtvis vara bra\cite{dynamics3}. D{\"a}rf{\"o}r {\"a}r det viktigt att v{\"a}lja ett fr{\aa}geformul{\"a}r klokt. Denna studie baserades p{\aa} en digital version av fr{\aa}geformul{\"a}ret f{\"o}r depression utv{\"a}rdering, kallad {\sc madrs-s}. Personalens inst{\"a}llning till digitala fr{\aa}geformul{\"a}r p{\aa} patientens smartphone bed{\"o}mdes i tv{\aa} fokusgruppsintervjuer vid Hagfors v{\aa}rdcentral. Resultaten visar att personalen har en positiv inst{\"a}llning till digitala fr{\aa}geformul{\"a}r p{\aa} patientens smartphone. De tror att screening och uppf{\"o}ljning genom s{\aa}dana verktyg troligen skulle vara till nytta f{\"o}r arbetet p{\aa} h{\"a}lsocentret. Resultaten visar att det borde finnas m{\"o}jlighet f{\"o}r sjukv{\aa}rdspersonal att kontrollera vilka fr{\aa}geformul{\"a}r patienten skickar till sjukv{\aa}rden. Vad g{\"a}ller det digitala fr{\aa}geformul{\"a}ret {\sc madrs-s}, ska formul{\"a}ret anv{\"a}ndas fr{\"a}mst f{\"o}r uppf{\"o}ljning. De kategorier av personal vars arbete p{\aa}verkas mest av digitala fr{\aa}geformul{\"a}r {\"a}r sjuksk{\"o}terskor, administrat{\"o}rer och psykoterapeuter.
