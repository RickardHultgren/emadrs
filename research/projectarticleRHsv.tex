...
\title{
\vspace{-3.9cm}
\resizebox{1\hsize}{!}{{\sc\mydate}\ Projektartikel för {\sc t10} vetenskapligt arbete vid l{\"a}karprogrammet, Ume\r{a} universitet}
\\\vspace{-.4cm}
...
\\\vspace{-.4cm}
\resizebox{1\hsize}{!}{{\fontfamily{iwona}\selectfont\small\cc Detta verk av Rickard Hultgren är licensierat under en Creative Commons Erkännande {\sc 4.0} Internationell Licens.}}
\\\vspace{-.3cm}
\vspace{-0.5cm}
...
\begin{itemize}%[label=\bf \Alph*.]\setcounter{enumi}{1}
