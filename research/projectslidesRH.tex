...
\usepackage[T1]{fontenc}
\renewcommand{\oldstylenums}[1]{{\fontfamily{helvet}\selectfont #1}}
%\date{\oldstylenums{2019-01-09}}
\date{2019-01-09}
...
\begin{frame}
\ \\ 
E{\sc madrs} {\"a}r en app f{\"o}r android som best{\aa}r av ett digitalt {\sc madrs-s} formul{\"a}r. Resultatet skickas via SMS till angivet nummer.\\\ \\

Att utl{\"a}sa fr{\aa}n {\sc madrs-s} resultat:
	\begin{itemize}
	\item allvarighetgraden av symptombilden.
	\item {\sc madrs-s} ger ej diagnos.
	\end{itemize}
K{\"a}llkod:\\
