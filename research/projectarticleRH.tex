...
This study was based on a digital version of the
...
madrs} could be used for monitoring diseases. Hopefully {information technology} ({\sc it})
...
influenced by results from digital questionnaires are nurses, administrators and
psychotherapists.
By reducing the administrative burden, the healthcare professionals
could focus more on the interaction with the patient.

In the medical {\sc it} debate of today, the topic of discussion is too
...
should be -- What kind of {\sc it} solutions can help the doctor to better
understand the patient's situation? Despite the technical
development, the meeting between the patient and the physician is
still an essential part of the practice of medicine. The physician understands the patient's needs by beeing empathic\cite{disc5}. After understanding the patient the physician can respond to the needs so that the patient understands the condition
...
''doctor'', which derives from the Latin {\it doc{\=e}re}, meaning to
teach\cite{disc2}. Digital questionnaires can hopefully give medical staff more opportunities to focus on understanding and responding to the patient's needs.
...
For at least the last seven years, the Swedish county councils' expenses have increased by approximately {\sc 5}\% per year. Adjusted for inflation, it will be approximately {\sc 3}\% per annum\cite{numbers3.1, numbers3.2}. The strategies in health care must change. Hopefully, this project can be a step in the right direction. The results show new ways to improve the communication between the health care system and the patient. 
...
\bibitem{disc5}Stewart W Mercer and William J Reynolds; \emph{Empathy and quality of care.}; Br J Gen Pract. 2002 Oct; 52(Suppl): S9-12. \\\textbf{\emph{\href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1316134/
