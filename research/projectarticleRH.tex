...
%\item {\bf One word exercise}: Each participant describes e{\sc madrs} with one word.
\item {\bf} Describe your feelings when a patient complains about something that is not related to depression, but the patient seem to be in a very sad mood? 
\item {\bf} ?
\end{enumerate}
