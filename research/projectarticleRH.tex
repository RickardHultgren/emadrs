...
Thus solving the difficult situation require new ways of dealing with depression. Some smartphone apps have been developed for the purpose of benefiting the health care of depressed patients. The apps could be categorized into two groups depending on what end-user they are meant for. If the end-user is a patient, then the app helps the patient to track and understand the symptoms through a mood diary\cite{app1}. If the app is meant to be used by health care staff, then the app is constructed around different questionnaires\cite{app2}. Both approaches may result in somewhat better results for the patient, but by focusing on either the patient or the staff a key aspect is neglected. In order for the health care staff to help the patient as good and effective as possible, it is necessary to focus on the communication between both parties.
...
At Hagfors Primary Care Centre, the staff's attitude is positive to digital forms on the patient's smartphone. They think that screening and follow-up through such tools would probably be beneficial for the work at the health centre. The results show that there should be a possibility for healthcare professionals to control which forms the patient sends to the healthcare. As for the digital questionnaire of \textsc{madrs-s}, the form should be used primarily for follow-up. The categories of personnel whose work would be most influenced by digital forms are nurses, administrators and psychotherapists. 

\section*{Limitations}
By using qualitative content analysis, professional-specific insights have been made. Thanks to the working method of focus groups, the participants have been able to discuss these insights together. This has resulted in good answers to the questions given. A major weakness of the study is that interviews were conducted at only one health care center. It is therefore difficult to accurately say what parts of the results also apply to other health care centers. For further development of digital tools, more research is therefore desirable. In order to be able to carry out credible research in this field, the researcher needs insight in the organization of health care, medicine and information technology. These three areas are the author writer familiar with.
