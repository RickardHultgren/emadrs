...
\item {\bf} Describe your feelings when a patient's major issue is not related to depression, but the patient seems to be in a very sad mood? \vspace{-.33em}
...
For at least the last seven years, the county council's expenses have increased by approximately {\sc 5}\% per year. Adjusted for inflation, it will be approximately {\sc 3}\% per annum\cite{numbers3.1, numbers3.2}. The strategies in healthcare must change. Hopefully, this project can be a step in the right direction. The results show new ways to improve the communication between the healthcare system and the patient. 
