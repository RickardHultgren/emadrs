...
The healthcare system is often focused on helping either the patients to manage a health problem on their own, or helping the healthcare professionals in their work. Less effort is put on the communication and dynamics between healthcare and patients. The outcomes from an interaction between patient and healthcare depend much on the professional background of the healthcare representant\cite{dynamics1, dynamics2}. Questionnaires can potentially be an objective tool to ensure that the patients' needs are always equally met. The major challenge with questionnaires is that even though the communication might always be objective and equal, then it does not necessarily have to be good\cite{dynamics3}. Therefore it is important to choose a questionnaire wisely. This study was based on a digital version of the questionnaire for depression evaluation, called {\sc madrs-s}. The staff's attitude to digital questionnaires on the patient's smartphone was assessed in two focus-group-interviews at Hagfors Primary Care Centre in Sweden. The results show that the staff has a positive attitude to digital forms on the patient's smartphone. They think that screening and follow-up through such tools would probably be beneficial for the work at the health centre. The results show that there should be a possibility for healthcare professionals to control which questionnaires the patient sends to the healthcare. As for the digital questionnaire of madrs-s, the form should be used primarily for follow-up. The categories of personnel whose work would be most influenced by digital forms are nurses, administrators and psychotherapists.
