...
From the recordings, the following codes were derived:\vspace{-1em}
<<>>=
library("RQDA")
openProject("/home/rickard/work/emadrs.rqda")
print(summaryCodings(byFile=FALSE))
@
%NumOfCoding <- table(Codings$codename,...)
%print(x$NumOfCoding)
...
Digital questionnaires would effect the {\it managing of communication with the patient}. According to the codes on page 5 the staff categories that are working with that task are: nurses, administrators and psychotherapists.
